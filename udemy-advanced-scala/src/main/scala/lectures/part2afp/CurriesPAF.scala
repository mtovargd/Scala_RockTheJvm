...
object CurriesPAF extends App {
  ...
  println(add3(5))
  println(superAdder(3)(5)) // curried function (receives a multiple parameter list)

  // METHOD!
  def curriedAdder(x: Int)(y: Int): Int = x + y // curried method

  val add4: Int => Int = curriedAdder(4) // needs the int => int annotation
  ...
  println(insertName("Daniel")) // assigns Daniel to the underscore var
